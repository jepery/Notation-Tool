...
DocumentMinor.onclick = function () {
  ...
  inputElementDocumentMinor.value =
    "Located a " + TPOLminorValidateDoc.value + " that accounts for the " + TPOLminorValidateIssue.value + " on the Recorded Mortgage. Doc ID: " + TPOLminorValidateDocID.value
...
FixOption1Button.onclick = function () {
  ...
  inputElementOpenDocumentFix.value =
    "Located missing Mortgage; verified " + TPOLOpenFixOneIssue.value + "; will open a Mortgage/DOT: " + TPOLOpenFixOneDescription.value + " and continue to work the new FIX deficiency."
...
OpenFixTPOL1.onclick = function () {
  ...
  inputElementOpenFix.value =
    "Opened FIX deficiency to correct " + TPOLOpenFixOneIssue.value + ". Reference Mortgage/DOT (Final Docs): Missing deficiency for previous procurement research."
...
FixOption2Button.onclick = function () {
  ...
  inputElementOpenDocumentFix2.value =
    "Located missing MTG; verified " + TPOLOpenFixTwoIssue1.value + ", " + TPOLOpenFixTwoIssue2.value + "; will open a Mortgage/DOT: " + TPOLOpenFixTwoDescription1.value + ", " + TPOLOpenFixTwoDescription2.value + " and continue to work the new FIX deficiencies."
...
OpenFixTPOL2.onclick = function () {
  ...
  inputElementOpenFix2.value =
    "Opened FIX deficiency to correct " + TPOLOpenFixTwoIssue1.value + ". Reference Mortgage/DOT (Final Docs): Missing deficiency for previous procurement research."
...
OpenFixTPOL2a.onclick = function () {
  ...
  inputElementOpenFix2a.value =
    "Opened FIX deficiency to correct " + TPOLOpenFixTwoIssue2.value + ". Reference Mortgage/DOT (Final Docs): Missing deficiency for previous procurement research."
...
FixOption3Button.onclick = function () {
  ...
  inputElementOpenDocumentFix3.value =
    "Lctd mssng MTG; vryfd " + TPOLOpenFixThreeIssue1.value + ", " + TPOLOpenFixThreeIssue2.value + ", " + TPOLOpenFixThreeIssue3.value + "; will open Mortgage/DOT: " + TPOLOpenFixThreeDescription1.value + ", " + TPOLOpenFixThreeDescription2.value + ", " + TPOLOpenFixThreeDescription3.value + ", continue to work new FIX deficiencies"
...
OpenFixTPOL3.onclick = function () {
  ...
  inputElementOpenFix3.value =
    "Opened FIX deficiency to correct " + TPOLOpenFixThreeIssue1.value + ". Reference Mortgage/DOT (Final Docs): Missing deficiency for previous procurement research."
...
OpenFixTPOL3a.onclick = function () {
  ...
  inputElementOpenFix3a.value =
    "Opened FIX deficiency to correct " + TPOLOpenFixThreeIssue2.value + ". Reference Mortgage/DOT (Final Docs): Missing deficiency for previous procurement research."
